...
export const performances = [
  {
    ...
    images: [
      { url: require("./images/Hoop_Dance/1.jpg") },
      { url: require("./images/Hoop_Dance/2.jpg") },
      { url: require("./images/Hoop_Dance/3.jpg") },
      { url: require("./images/Hoop_Dance/4.jpg") },
      { url: require("./images/Hoop_Dance/5.jpg") },
      { url: require("./images/Hoop_Dance/6.jpg") },
      { url: require("./images/Hoop_Dance/7.jpg") },
    ],
  },
  {
    id: 2,
    ...
    images: [
      { url: require("./images/Magic_Wand/1.jpg") },
      { url: require("./images/Magic_Wand/2.jpg") },
      { url: require("./images/Magic_Wand/3.jpg") },
      { url: require("./images/Magic_Wand/4.jpg") },
      { url: require("./images/Magic_Wand/5.jpg") },
    ],
  },
  {
    id: 3,
    ...
    images: [
      ...
      { url: require("./images/LED_Glow_Show/2.jpg") },
      { url: require("./images/LED_Glow_Show/3.jpg") },
      { url: require("./images/LED_Glow_Show/4.jpg") },
      { url: require("./images/LED_Glow_Show/5.PNG") },
      { url: require("./images/LED_Glow_Show/6.jpg") },
    ],
  },
  {
    id: 4,
    ...
    images: [
      { url: require("./images/Aerial_Hoop/1.jpg") },
      { url: require("./images/Aerial_Hoop/2.jpg") },
      { url: require("./images/Aerial_Hoop/3.jpg") },
      { url: require("./images/Aerial_Hoop/4.jpg") },
      { url: require("./images/Aerial_Hoop/5.jpg") },
    ],
  },
  {
    id: 5,
    ...
    images: [
      ...
      { url: require("./images/Sphere_Dance/2.jpg") },
      { url: require("./images/Sphere_Dance/3.jpg") },
      { url: require("./images/Sphere_Dance/4.jpg") },
      { url: require("./images/Sphere_Dance/5.jpg") },
    ],
  },
  {
    id: 6,
    ...
    images: [
      { url: require("./images/Fire_Performance/1.jpg") },
      { url: require("./images/Fire_Performance/2.jpg") },
      { url: require("./images/Fire_Performance/3.jpg") },
